(function(root, factory) {
  ...
  echarts.registerMap('澳大利亚', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Ashmore and Cartier Islands' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
          ...
          encodeOffsets: [[[125669, -12524]], [[126290, -12846]]],
        },
      },
      {
        type: 'Feature',
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@VTM^RbAZ\\`EdpvEdSLEhbʼƶcCWvWISZSMSdkKGe}ITUb@RYM\\eKKgWVN_INeWuImKeXQcU`AgcP±PKKR­TMC}^gUcJQ[TqBsOQDkQEsGwOYj­PQ\\FZihX`GOQH[eEeuXM^bOXTqVE`ZX]rh`_jSÔ',
          ],
          encodeOffsets: [[152334, -36347]],
        },
      },
      {
        type: 'Feature',
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@j[rGxN^PjnL^xDP}GQLeeMcqDaOeGmDOOTNMLsB[YSLhhLbUbZP',
          ],
          encodeOffsets: [[108095, -10699]],
        },
      },
      {
        type: 'Feature',
        ...
        geometry: {
          type: 'Polygon',
          coordinates: ['@@Oÿo{K¯JkO}X}fQ]X@~c^DTHiGRYpNNXSA|SČbIcI¡¶uK'],
          encodeOffsets: [[75542, -54395]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Jervis Bay Territory' },
        geometry: {
          type: 'Polygon',
          coordinates: ['@@fYGQycWe@qi@dUbmDKoSTfMXHlhDRI'],
          encodeOffsets: [[154318, -35965]],
        },
      },
      {
        type: 'Feature',
        ...
        geometry: {
          ...
          encodeOffsets: [[[162895, -32311]], [[144384, -29695]]],
        },
      },
      {
        type: 'Feature',
