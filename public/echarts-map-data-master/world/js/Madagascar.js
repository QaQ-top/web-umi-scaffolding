(function(root, factory) {
  ...
  echarts.registerMap('马达加斯加', {
    ...
    features: [
      ...
      {
        type: 'Feature',
        properties: { name: 'Province de Fianarantsoa' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@qªPlCitB¦UrsH\\kDs\\sS}¨nLlM|Y¥dYAaE@ybmq@kà~NkKzi¨@pBN_xAzwHp^SZ[fLhnEDpvF°vRqEhl|^z@zhxfPDhvn^tuX@N¦D´erdx_HÀIÞ`_T¡OoÅS{WéD}dj@p]OfwbU¼znJ´Qp`NEtaAPÈdF ª¾SČFtIX[YjepKHKoÐMĵWģQ]ïiÍaÓK¥¯ŭ÷O{ķkÍÅƷąɉkëǕÇŵ]§§ŗaě_ÑIõ]AŹčY³M«gã}÷ėoÿ]ćeÛE±cyAeq¡³Ľ]ikgi{LMpJ]EoÁN}dI\\}_WMqåocJ[vgA¥}DUqiwA[UÑOM¢NO¢[l§lµNwläeg`T¿jûYZOXzjr´R|CzspElvxrxªDªU@vZEjwÏ®g}¢£Ą±Č·ç³TCģqm}CĽ»wogáY]e@o]ciïRdaA©mP¯kGNÆíJEtIª_¢Bt\\vpĂJºVx|pp¼ÊjjjFjG^JnOXMNapOvNI|«²]~Rhøn|FĈR¨pNXnxTQ^ZxJVjB_tUªºp®DVvÆªÖrnfZmĨ¸U¢IJ_~vüDnlbd|Tþia¬\\N°`ºImCi]¦LÎI~\\ªehI~Dbp',
          ],
          encodeOffsets: [[46871, -20356]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Province de Mahajanga' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
      ...
      },
      {
        ...
        geometry: {
          ...
          encodeOffsets: [[[48814, -20551]], [[51021, -17472]]],
        },
      },
    ],
    UTF8Encoding: true,
