(function(root, factory) {
  ...
  echarts.registerMap('波斯尼亚-黑塞哥维那', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Brcko district of Bosnia and Herzegowina' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@HDD@@@r`@Ld^zNbjjPºVfwWGRMYdUGeªosĸExJSY£D[sqßTq{MKV»aqiiJsKO\\FyKrQnN`uv@~b',
          ],
          encodeOffsets: [[19025, 45914]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Entity Federation of Bosnia and Herzegovina' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
          ...
          encodeOffsets: [[[16680, 46076]], [[18922, 46144]], [[18635, 46161]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Republika Srpska' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
          ...
          encodeOffsets: [[[19262, 45830]], [[16680, 46076]]],
        },
      },
    ],
    UTF8Encoding: true,
