(function(root, factory) {
  ...
  echarts.registerMap('海地', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Artibonite Department' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@P}ISS@e`GP`^KXeadarORpwCQtkr[{`InRR`Q\\ZXXMflbUIDsQWPSCmJ]Oil@®LG_NWrWIcMb_Pp[EUos]S@q_RYMWR^KlqiYBcbaaSOVuBVQUe]ã­HSKXYGnqByeELeP»NqQoLc]WaaXCbQh}t`Yx`l\\GlXLxhgd]~MrRxHpMzRHT[|sAelPtdFVWtpa`BflSHchhebJx{BKSkCcPYnip}b]^bbX|WBr£XeU]ZbzEhNVzXPbV²grL^EtHDW¢OHPbxTBXbK||hHfM',
          ],
          encodeOffsets: [[-74425, 20285]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Centre Department' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@ZHWTL®G^äVfURAUvTPb abAdjZkr]LQNXQZr`@^TptjMr]JgfIVRxFnPXhfAlTli O\\wfGbJ`WCVIrJj^l[THt{´WXiaMWO]HM[wqUq¡mgq]QOgBs`Frl¬k^|_\\_@HMAy_ç_C]eM£{@eHm^HyEy[wIoBeMMgWgPoly¦eHhEhkBaK_vwjCN',
          ],
          encodeOffsets: [[-74101, 19319]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Département de la Grande-Anse' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
          ...
          encodeOffsets: [[[-75501, 18995]], [[-75568, 19050]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: "Département de l'Ouest" },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
          ...
          encodeOffsets: [[[-74803, 18905]], [[-75051, 19394]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Département des Nippes' },
        geometry: {
          type: 'Polygon',
          coordinates: [
          ...
          encodeOffsets: [[-75550, 18867]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Département du Nord' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
          ...
          encodeOffsets: [[[-74302, 20357]], [[-73765, 20182]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Département du Sud-Est' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@r\\KL`|GpDFl L^WxO\\pTELleZEVjpRfKRlhA^kj|pI~t\\ndVhKGlJYkRKZ|OEWV_S@VZpHSzJVMhDnQ Ctc¬ETI¦JhSX|JJeC{n@PNfG\\PtGTl@{£EaWMEm]WF_`OpsIq\\c@aQsYYkNAbtgpoZPw^SKiTQ^NS{FS@SJ}BmMgT­H«SE{DScdiU\\qIgT}DmPkMUFW}RUQVkwNY]GsRMMN^D{RYRKPA|D~KRJv`fCd',
          ],
          encodeOffsets: [[-74748, 18764]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Nord-Est Department' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@jNhE|LCptRhOA^MCFoqYkHVihJt@pYFnyTEp@¤OJulaD_YYF£|Bg\\kfßaDgXcG]gAOQpFci]qIUJD_XaIeH[xPkjXT_dkohMXkXOOkXd^Rb{hEdSRNZs¤bdMPNpZOxRAjPj@b',
          ],
          encodeOffsets: [[-73788, 20166]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Nord-Ouest Department' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
          ...
          encodeOffsets: [[[-74302, 20357]], [[-74722, 20546]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Sud Department' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@KLQpOfrcP[_YéHEX'],
          ...
          encodeOffsets: [[[-75477, 18539]], [[-76236, 18799]]],
        },
      },
    ],
    UTF8Encoding: true,
