(function(root, factory) {
  ...
  echarts.registerMap('百慕达群岛', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'City of Hamilton' },
        geometry: {
          type: 'Polygon',
          coordinates: ['@@FDL@BMMAEL'],
          encodeOffsets: [[-66343, 33073]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Devonshire' },
        geometry: {
          type: 'Polygon',
          coordinates: ['@@T[EACGKEKL]OI\\TDTHNH'],
          encodeOffsets: [[-66303, 33093]],
        },
      },
      {
        type: 'Feature',
        ...
        geometry: {
          ...
          encodeOffsets: [[[-66267, 33105]], [[-66252, 33117]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Paget' },
        geometry: {
          type: 'Polygon',
          coordinates: ['@@VFDHLHHB^PLKc[GIMKICSZ'],
          encodeOffsets: [[-66348, 33057]],
        },
      },
      {
        type: 'Feature',
        ...
        geometry: {
          ...
          encodeOffsets: [[-66330, 33083]],
        },
      },
      {
        type: 'Feature',
        properties: { name: "Saint George's" },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@B@HFPE@GJDBGWEMR'],
      ...
      },
      {
        ...
        geometry: {
          ...
          encodeOffsets: [[[-66421, 33045]], [[-66438, 33081]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: "Smith's" },
        geometry: {
          type: 'Polygon',
      ...
      {
        type: 'Feature',
        properties: { name: 'Southhampton' },
        geometry: {
          type: 'Polygon',
          coordinates: ['@@^N@CBU\\GdHBDNFLBLOUKK@KCKBSBGCM@OJQPAF'],
          encodeOffsets: [[-66436, 33038]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Warwick' },
        geometry: {
          type: 'Polygon',
