(function(root, factory) {
  ...
  echarts.registerMap('挪威', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Akershus' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
      ...
      {
        type: 'Feature',
        properties: { name: 'Jan Mayen' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@o_yI[YiMWQ[IkGmCOOMcCo[_CKDQDDZ_ViNGJdZl@dCjFj`BJNENRtXhJBHXLNJVHF\\ĒJNJRRTNNENT^nTP^VNnRDJ¾jdRjNĒ`nL¨BxFHRZDAVDxCxF`GdUYSIO[KDSiGUGScH]EM`uQiQE¡Uw@KSBÓQEÃQÏKgG]Je@ÍG£KK«UákIG',
          ],
          encodeOffsets: [[-8917, 72626]],
        },
      },
      {
        type: 'Feature',
      ...
      {
        type: 'Feature',
        properties: { name: 'Nord-Trøndelag' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@EMRCKSyHWPVFG'],
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@üºbBGJAXSZSTz^dHpC@fOTK`D^HvSBGWUVKnwlGVBEO@cI[POPJTqXHRKPAfWREFZ[AORgaOMOOcMqA]JSVQHQRQOOSBaCi]UD[GSP{BIPYEyDMJJPZZFTCROPQBYbBJMPMIUReIYPMARSYK[CUPAViCQFORBLRNAdijoJdgFe@{d',
          ],
          encodeOffsets: [[10741, 61458]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Østfold' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
      ...
      {
        type: 'Feature',
        properties: { name: 'Sogn and Fjordane' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@KW[AOHCZdDXK'],
