(function(root, factory) {
  ...
  echarts.registerMap('菲律宾', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Autonomous Region in Muslim Mindanao' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@@Vvc^njPkQ¯IcSC'],
      ...
      {
        type: 'Feature',
        properties: { name: 'Cagayan Valley' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
      ...
      {
        type: 'Feature',
        properties: { name: 'Central Visayas' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
      ...
      {
        type: 'Feature',
        properties: { name: 'Cordillera Administrative Region' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@`vXFHh^TvBHkWzWÂoĀ·¨cjeZ}IYA}I_CSkµsmU][¹IYEy}DÐJXoxË\\}jSrg^m^a§Ò}Fs»o§Wim¿B±FyB¯]^«FġCY_]]KIkWocOi@{UkR}wMc]YHCaaQXQK]ikB_kSE_Pq[gF_cJÛ[MiM±MāaKIGkAEuLCymi£i}mR_Wqe}IqJwçauRd«hqNUNsĎ[¦WĚĎľ Fjf¾CJAª\\¤AtRVlVvN|ADXPfrHGF¤Ht^~t|j^lPMRwTe^UF][]iSkYSqC}w^\\UZAdVIYBOh]lZDdTLdnTlJ~ELkDw^AeaW@OdFjP^FvzÈPrXvºJVbfZR¦PbJVVxdjZrbL@SZjEjfLHnSBhGbzvIpQZVCTktBVxHnÐShAbN´Rp',
          ],
          encodeOffsets: [[123863, 18889]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Davao' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
      ...
      {
        type: 'Feature',
        properties: { name: 'Eastern Visayas' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@MJJlWzNPXyI'],
      ...
      {
        type: 'Feature',
        properties: { name: 'Metro Manila' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@\\ZvsNLuVPh[tDHhdFbZLdEVQh@TKZI^DKqZOWMCAo`CPUIsiDO_T{Yk@_TKG]WKGecBa©ACYJmMUaCgaOAFarOdSLOvHT^bJV_LJXAPHM`]ZS¢Wncvg`',
          ],
          encodeOffsets: [[123808, 15054]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Mimaropa' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@VV~OBeRijceMQt'],
      ...
      {
        type: 'Feature',
        properties: { name: 'Negros Island Region' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@FUSMasIHz'],
          ...
          encodeOffsets: [[[126410, 10732]], [[125767, 10800]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Northern Mindanao' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
      ...
      {
        type: 'Feature',
        properties: { name: 'Zamboanga Peninsula' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
