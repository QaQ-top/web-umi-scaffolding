(function(root, factory) {
  ...
  echarts.registerMap('缅甸', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Ayeyarwady' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@l\\r_Y'],
      ...
      {
        type: 'Feature',
        properties: { name: 'Naypyitaw' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@°er` µy``¨^ÈHºS]ĂZ°SòÕ²e}uÇcm³M|£¤£ZÅÂTsXÖÉn¿¡XqU¬BvµOSIg_£Cqfĝ_ĻRċHQ±©eQ½nÃC[čl¡oÒL®aZ¦¨fcphHxLM¶oR~up¦[¬ÔK¯Ģ',
          ],
          encodeOffsets: [[98035, 20799]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Rakhine' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@\\buek'],
      ...
      {
        type: 'Feature',
        properties: { name: 'Yangon' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@¦KO|nV^vF^¸LNz|h¸ĈDfcÌýã^´admLxïOmZµeoer\\q×xeÐ_|äY¾`¸JsBt¡qdÑµQ«m¥čÇã{á@¯¿u¬FqrYÀDjÇ|gM»vÕzqCo¡iQÛyNë¨·KVe¢{z¬MvDaZ|U~b~XF~SÌyXhU|ªCn^n©ô@h~Fkz`tFq¨ÇAR¢P` ',
          ],
          encodeOffsets: [[98034, 17898]],
        },
      },
    ],
    UTF8Encoding: true,
