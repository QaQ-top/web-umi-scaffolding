(function(root, factory) {
  ...
  echarts.registerMap('比利时', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Brussels-Capital' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@XRAJzHH^M\\f\\ETXDpT@ZGXZVH`CFK`UKGTYSAKSJIjO`EFaX]eIUO[cI@YCJeH}DURGXYFUTWASJYAEL[F',
          ],
          encodeOffsets: [[4346, 52040]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Flanders' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@PPdI@MsH'],
