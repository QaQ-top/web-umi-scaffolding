(function(root, factory) {
  ...
  echarts.registerMap('几内亚比索', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Provincia Leste' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@fB͖CêFĐG®BĬAŲB\\AɆ@~AAÉr©\\V@P]V_Ls@eSS_CcP]NQASY]ReKSUKOJKIGYOGKm[i]BWjSLSAYoiAOLARZPClKBOge_EjGHaC[QZ[IcImCWsQQgAD]EIR[AOX]THGjOP{zMVB`KPODwRCJSNElaN@pStCTSQ«CIN¡ABaH]OUBQ@mICIu[YCuXL`EPsYYjVJOVQJSIY@@MN[RGSWCQSgG__D}dYIE]KK¥YXeBGS_BkekJMPe\\MVOs`aG[FSMUBWXm}mmaxMlAZcFcAUhcVaCKK]KeFASGYeWASrINWHQEI_BWY@C]UWkFQM[L]he\\UH]XB^EhHLGTgLwDKSUNFPRLBP\\C^jGLkEMbYEKSQ@IfH`MR_DcCGUTYIUgKeHoUTLKLYBdDTtNlCd\\DX^jK\\DXRJbKTSHA\\iVebO\\EZ[fæIbfNDdK^LtYVArRElDjOn@TRXsSIHbPZKbJ^CRL\\@pNPRRFyQTkXHRjlJdlhTZBhIZONSr`',
          ],
          encodeOffsets: [[-15270, 12983]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Provincia Norte' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@_TqPMJYAgSYkgIcikGQlWRSzQEOQoM[@QK]DaIYLaOGJTtQW@SPmCiFkqQUBsZ]KcLMCeJaå\\eFYP[fajUB[TGLSIaWQ[CiLTqA]MwgWQaQeC±J£FVqFÏGgGaSYS§­]´GLYFoaVIG@YSGHOWE@SMQMCIYMGQ]QqAQCDYw[_Qg_QAeRPWQMNCcC[K]WípgF[AKI]jWRQ@hEJQ¤[XgCQO@OWO_KYHYIYVqJSOOJMCYP`NPnPdNIW~[TKPUNTRFTAhMhWdÿæy\\IIWRWlepIBQJwDMVSV_VwJ]\\cROC_SKJxhdAD|YÂ\\U|PÈRGLZbfl`TLlPTG~OĀl~BaYÂPlCĴ[ÈSÂznXpTb¢j¼rrbv|Tbh²njH@ǮO',
          ],
          encodeOffsets: [[-15270, 12983]],
        },
      },
      ...
      {
        type: 'Feature',
        properties: { name: 'Setor autónomo de Bissau' },
        geometry: {
          type: 'Polygon',
          coordinates: ['@@RrR^NHJZNDNR@TXFGPTH@ZJHbUpZEHKcQ}CYYOeC]UaeUGB'],
          encodeOffsets: [[-16036, 12122]],
        },
      },
    ],
    UTF8Encoding: true,
