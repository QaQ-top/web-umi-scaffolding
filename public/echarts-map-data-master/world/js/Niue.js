    ...
    features: [
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@mNBn\\ZACcC]uuKMMJuNEAKFEEuJBDFFD@\\TF@DFHDBDFN@L@HCJERAN',
          ],
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@LNvvdkvmGEEGIKMKIEIIKMGO@AGGQ@WEKCIEA@BzEBFD@FCBAHJhIL',
          ],
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@D^\\VdFdNDIDCBEDEBCDGB@DI@CJMDADIAGEG@CCIOSCCCECEGKIEuncl',
          ],
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@X`VZMVBFE@CHL@VCPEL@FALCHCFGDKBI@KAAMA@GSBIUYACU_[Ot',
          ],
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: ['@@RScEBHHLHF'],
          encodeOffsets: [[-173968, -19424]],
        },
      },
      {
        type: 'Feature',
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: ['@@dFhgPsy^]XSFFHJR'],
          encodeOffsets: [[-173977, -19437]],
        },
      },
      {
        type: 'Feature',
