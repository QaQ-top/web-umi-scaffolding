(function(root, factory) {
  ...
  echarts.registerMap('冰岛', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Capital Region' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@LÞHtsLjv^vk¦Z[RoVl]ªVvU¤\\DzZJ¤|KRiluLS@tlJ¸nPÊVSTĖnN[BÈUFGZ¼^ A´SÌmś±ĉ§TaÉ¥£ĥÝfWk¯DPėKŏYëBđÀ',
          ],
          encodeOffsets: [[-22656, 65578]],
        },
      },
      {
        type: 'Feature',
      ...
      {
        type: 'Feature',
        properties: { name: 'Northwestern Region' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@ªsUkzgzGªiSQ®o[Remfk]GuYKFqm@maGjW¸Q{SIYtW@Wrkq[CwQp}Mm]Y}A~WĐsdU\\m£kCSIGY^oMg]°¾Ma@¡ŤSU@µ¡Ýr]b]QW\\iµQI]ïIY[W¥ZlVfebN¡bIR¡do@m_ZŵZÍM»gmaKkbM§YWk¥RIgY@Iw\\ašRťHĻlċIĭ´ORl^mVčXEJǷCgVSŁAÝrāP¡eBã£Bāt{@čRõnmÆU`tBbPDAWr¢t^S^~rAt_ºDvWbNnaH]{DRPMhe`[VfhnERvĐl¨lúI]oVYKKüAĴ\\¼bfZNOjY¨DÀD|t kdNEfÂG~H¨l¨Y¦wtMJetSKW|qkPw`_kV¸E¨YaZYpXEEreI´DI\\dXve_rF®bBfnRD\\_btnMpXgz£lO\\ü^\\^K^}|PXênüFN]PWRR²dT',
          ],
          encodeOffsets: [[-19501, 67748]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Southern Peninsula' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@Ē¿ìAŐZĘLOȱŃFkëEÝM»NKÉLqP@uTsBasD]Ha_{GÛVÓklzfVddDfxHF`§RghDdXFhKvlK¤{pOtqNBÀIBfvZnCÆjÈa|JZNR',
          ],
          encodeOffsets: [[-22656, 65578]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Southern Region' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@LGBaWwDIlYF'],
          ...
          encodeOffsets: [[[-20804, 64966]], [[-22189, 65524]]],
        },
      },
      {
        type: 'Feature',
