(function(root, factory) {
  ...
  echarts.registerMap('所罗门群岛', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Capital Territory' },
        geometry: {
          type: 'Polygon',
          coordinates: ['@@²UbR[osí`Dd'],
          encodeOffsets: [[163753, -9650]],
        },
      },
      {
        type: 'Feature',
      ...
      {
        type: 'Feature',
        properties: { name: 'Choiseul Province' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@svDj¤|tEt\\QS¿DeT'],
          ...
          encodeOffsets: [[[161522, -7646]], [[160521, -7199]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Guadalcanal Province' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@dZÚu¨zÆmÂ\\SzZ]Tmk~slC®a £IfoBČËUsTfum©e¥EíkbBnX§Og|Ç¨ÑRćWÃDS§\\óZfg£za~lqD@ctRP@\\^~eňFªn~vN¢|Kbi¨qt{ ·PDCcî_ptQ\\',
          ],
          encodeOffsets: [[163853, -9644]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Isabel Province' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@Jp~r\\iDQÎTsLsbe'],
      ...
      {
        type: 'Feature',
        properties: { name: 'Makira-Ulawa Province' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@uAXzg[a'],
      ...
      {
        type: 'Feature',
        properties: { name: 'Malaita Province' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@kä\\WemXąP'],
      ...
      {
        type: 'Feature',
        properties: { name: 'Rennell and Bellona Province' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
          ...
          encodeOffsets: [[[164087, -11965]], [[163670, -11579]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Temotu Province' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@quzW{mb_l²QNu'],
