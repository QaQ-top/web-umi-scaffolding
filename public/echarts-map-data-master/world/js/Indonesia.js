    ...
    features: [
      ...
      },
      {
        ...
        geometry: {
          ...
          encodeOffsets: [[[118258, -8972]], [[117600, -8639]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Bangka-Belitung Islands' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@ISmAA'],
      ...
      },
      {
        ...
        geometry: {
          ...
          encodeOffsets: [[[107709, -6808]], [[109288, -6234]]],
        },
      },
      {
        type: 'Feature',
        ...
        geometry: {
          ...
          encodeOffsets: [[[104538, -5485]], [[103450, -2543]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Central Java' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
          ...
          encodeOffsets: [[[111499, -6972]], [[113103, -5955]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Central Kalimantan' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@NM'],
          ...
          encodeOffsets: [[[116088, -3380]], [[113389, -3068]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Central Sulawesi' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@]H{ÐxYb½'],
      ...
      {
        type: 'Feature',
        properties: { name: 'East Kalimantan' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
          ...
          encodeOffsets: [[[116948, 1444]], [[121349, 1414]], [[121501, 2216]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'East Nusa Tenggara' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@ÂwªCrÔEblyÚĆ]£e¸EM¸Ú_l RÖijXL~mOªx}IaWC~i Ca¨B [@q}QypeCqsWX`O{CclkeĕOÇXt¥jy¢}`mxÓiLÅK©PťiamqDi`ƕAgpō§a\\ďcmlawFég_ÕMµu´ÃĉEnsm^ÝukdTusqFG\\UlIÃUyFvIpº²¾Q¼PSn`rS¨HxW¨^LtÈEz`¼`ªxÂjbj¢JÂjkvEN|Þ¶rK^À',
          ],
          encodeOffsets: [[125128, 1060]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Jakarta Special Capital Region' },
        geometry: {
          type: 'Polygon',
          coordinates: ['@@JĉuGsO^GWÝ\\N{Aöq}XHÜPf[Čer²C|N'],
          encodeOffsets: [[109537, -6237]],
        },
      },
      {
        type: 'Feature',
      ...
      {
        type: 'Feature',
        properties: { name: 'North Kalimantan' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@`l`sDk§Od'],
      ...
      {
        type: 'Feature',
        properties: { name: 'North Sulawesi' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@|Dq»mgAOn`'],
      ...
      {
        type: 'Feature',
        properties: { name: 'Southeast Sulawesi' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@m~d¸°}ćUe¡X'],
      ...
      {
        type: 'Feature',
        properties: { name: 'South Kalimantan' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@vW·w'],
      ...
      {
        type: 'Feature',
        properties: { name: 'South Sulawesi' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@Lhas©wsTA`pP'],
      ...
      {
        type: 'Feature',
        properties: { name: 'South Sumatra' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@lB l´\\PªhdExwª@ÆcD~p¶KpjHêf¤@HxpKx{v°vCpg®BapkcîM jlHz@lcp£NÊ£¦¯xAPî[¨X~DXvxFÚfàOnXÞºênbVêBzV\\|dC{ĦBYłľLXtQr P~Mo£jÍw±Fhvd|ºk¡¨@l\\ĢS¦£f·P×ÁÁUD±¥óKv^TªÊ@C^aÎLq¼U^Wð¦ĄĨaÂDè[nexX{ċD|ÍØYxPVÁQûNvW Hvd`iEPÅMÁëGÝ¹£±ħqÓSýTz}È§O¥åñgýFuI]TqPBR_Dte£TvulJV{CahGHk\\½_I Z[¹gGP»sX¥_]·g¡¥ā£qPÏ}©»[Rħ@k|¥µuWYÇgsycUcYe¯hţKlsPR­[ħlMq{GhěQwr[·mQarhl|BrQODtc|yAvD¶×ôK|tªxvsÊqJÁoW`³^Azmzĳ|RE°kÎfµU×Jkbae}B¹|myx³oTà|TÌj~jHÆ\\q¨Ç ¢dfLP¬KĐHÉUI×Ji¦SmeE³fv_nFÚSÀ¤§\\ÉoxNoUºõºG~g',
          ],
          encodeOffsets: [[104513, -2836]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Special Region of Yogyakarta' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@~K|æfL¢¸L¾af~lD¤S~£¤üÆfmRËpĕ³bcĢK\\ZnNCµ[C×YpRC¬wGqRçGğ¨×`ć¹|}ĻıÂċ',
          ],
          encodeOffsets: [[112644, -8077]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'West Java' },
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@EâJ¼z|ps`BÜBîm¶AâF`w`ªnb¡|z¸gL_ƨDV|BMÞ[XH ]PHtvIĊjHjÂN¬[~XÄg|®cü|ÊSæœÔæM¿L¼t¨CJo¢¦_þ«ðm¼n®ÜS¢cvAHp£©~{ÜT«@Ó^éÇ|[xhnYNzUErµbEG¿{}kGïkcEÅ©YyGd½dAsNh}ÒJl_\\Osē_±V[kç|ygbJÇOcMVqW}¿uíFħbƟs\\ñjēCa¥p¿XyCM~ïÎćo\\ßvIĥZŻƝ`éHGǇpyG¥T¥§Xo[Gozxİ¸DS¤lPKÖu`ÅZ©u',
          ],
          encodeOffsets: [[108950, -7147]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'West Kalimantan' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@}GSf|{Sw'],
      ...
      {
        type: 'Feature',
        properties: { name: 'West Nusa Tenggara' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@iDHÌt«Qc'],
