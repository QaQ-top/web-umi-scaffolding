    ...
    features: [
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@J~¨¨JĮb~gÖh¸I¼j¨RÂd¸HÆc~ĂPÜa®·PċAóÝf_ªGA¿EuËHMÃ¬w}³½ÃwS©ǁb',
          ],
          encodeOffsets: [[-90214, 13489]],
        },
      },
      {
        type: 'Feature',
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@ĸjW²|¼_ĂbÇgbqAuSFÐÁÀIOsiäDJg·hÕa}Iĭ§§I}sK¹ÈVTá¸·HbĮeü\\´nu~£D',
          ],
          encodeOffsets: [[-90659, 14075]],
        },
      },
      {
        type: 'Feature',
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@ JswYÉ¥sJă»Jk{lxDQÓ»L¹eßqnVon­m«Þ±`tÐCzU|Ø  hEÌfJt¹ÒO|^ÐÈGbcy',
          ],
          encodeOffsets: [[-91500, 14767]],
        },
      },
      {
        type: 'Feature',
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@äMcƦ·Id¯g³êsªÃÒCz¿w­kAiiÏ_sµJ§RknÜï`}_čD¥j§_WwwCkl|IĄ¼I¦tZÊxIt',
          ],
          encodeOffsets: [[-91500, 14767]],
        },
      },
