    ...
    features: [
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@РðɾYƒÀǪIƪŴOaõ΋ȨKƮăĐØĨƯοn͋Á̐źÂŔiƎÈÐfžàƼĵĨ²ǈĺǔ̚Ɓƽ˭®ǏOʅª½IƵůƎȍÀCĸȟYŵƁǧ`ɕƩďŋÃŹĿĵǋNĺƵSœŶċÅǻUÅąĩrȹǁļƻʃàmŜ˷ā³˯ĘœXĭâėCǏɶēǚyŎǅǾHƤïƀSǞʟËºRļƏň±ƀƕǄwƊİņIĮĪȖãƸäĜƀðǸiƠpkÜŬäĀ',
          ],
          encodeOffsets: [[-58595, 5390]],
        },
      },
    ],
    UTF8Encoding: true,
