(function(root, factory) {
  ...
  echarts.registerMap('法罗群岛', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Eysturoy region' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
          ...
          encodeOffsets: [[[-6850, 63511]], [[-7288, 63798]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Norðoyar region' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
      ...
      },
      {
        ...
        geometry: {
          ...
          encodeOffsets: [[[-6931, 63179]], [[-7023, 63257]], [[-7119, 63399]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Streymoy region' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@nJ~]hcMKkPyf_N'],
          ...
          encodeOffsets: [[[-7100, 63453]], [[-7434, 63669]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Suðuroy region' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
          ...
          encodeOffsets: [[[-7170, 63102]], [[-6931, 63179]]],
        },
      },
      {
        type: 'Feature',
        properties: { name: 'Vágar region' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
          ...
          encodeOffsets: [[[-7644, 63626]], [[-7849, 63593]]],
        },
      },
    ],
    UTF8Encoding: true,
