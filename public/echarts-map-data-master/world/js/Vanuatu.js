(function(root, factory) {
  ...
  echarts.registerMap('瓦努阿图', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Malampa' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
      ...
      {
        type: 'Feature',
        properties: { name: 'Shefa Province' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@XeaKaTl^'],
