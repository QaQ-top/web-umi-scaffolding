(function(root, factory) {
  ...
  echarts.registerMap('土耳其', {
    type: 'FeatureCollection',
    features: [
      {
        type: 'Feature',
        properties: { name: 'Aegean Region' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            ['@@PGHd_iSPAPjdF'],
