    ...
    features: [
      ...
      },
      {
        ...
        geometry: {
          type: 'Polygon',
          coordinates: [
            '@@rTTR[ZD^NXVF|sVsEDZVv^GPfobhH`PvQvEBLaVfjVF~@PZ^BAhrAMKRUB[zKh@hLjfvYTFNVfA\\LmR`JlBDYpUT@K_WGMiTY^@rIeJg|IR]@DGoYiFS~PhI`OfB^GZYvIWO[mROKMaAs]RSMOkA]]O[YRN~]HiO_jyKyB@NgLKWrO@[RiMSBAV_Ly\\Q_`oSo@GbmAuIYAQFcZaDCP',
          ],
      ...
      {
        type: 'Feature',
        properties: { name: 'Mecklenburg-Vorpommern' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
      ...
      {
        type: 'Feature',
        properties: { name: 'North Rhine-Westphalia' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
            [
      ...
      {
        type: 'Feature',
        properties: { name: 'Schleswig-Holstein' },
        geometry: {
          type: 'MultiPolygon',
          coordinates: [
